...
#adminPassFilename = "first_secret"
#adminPassFilePath = os.path.join('/','run','secrets',adminPassFilename)
#adminFileOpen = open(adminPassFilePath,'r')
#adminFileRead = adminFileOpen.readline()
...
adminToAdd = userTable(username='admin',password= bcrypt.generate_password_hash(os.environ['adminPassword']).decode('utf-8'),multiFactor='12345678901',accessRole='admin')
